...
contract Customers {
     ...
     */
    function customerExists(address id_) external view returns (bool exists_) {
        require(id_ != address(0), "Id is empty");
        if (
     ...
     */
    function addcustomer(Types.Customer memory customer_) external {
     ...
     */
    function updatekycdoneby(address id_) external {
